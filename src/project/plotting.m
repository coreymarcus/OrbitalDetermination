...
Pyy_post = NaN*csvread("../../data/Pyy_post_proj.csv");
...
plot(z(:,2)/3600,20*ones(size(z(:,2))))
plot(z(idxs,2)/3600,1000*3*sqrt(Pyy_post(1,idxs)),'r')
plot(z(idxs,2)/3600,1000*-3*sqrt(Pyy_post(1,idxs)),'r')
title('Post-Fit Residuals')
grid on
ylabel('Range [m]')
legend('Station 1','Station 2','Station 3','20 m Bias')
...
xyfig = figure;
sigval = 3;
scatter(devA(1),devA(2),'x','HandleVisibility','off')
hold on
scatter(devB(1),devB(2),'x','HandleVisibility','off')
scatter(devC(1),devC(2),'x','HandleVisibility','off')
scatter(devD(1),devD(2),'x','HandleVisibility','off')
scatter(devE(1),devE(2),'x','HandleVisibility','off')
scatter(devF(1),devF(2),'x','HandleVisibility','off')
scatter(devG(1),devG(2),'x','HandleVisibility','off')
...
xlabel('Radial [km]')
ylabel('In Track [km]')
legend('Case A','Case B','Case C','Case D','Case E','Case F','Case G','Location','best')
...
xzfig = figure;
scatter(devA(1),devA(3),'x','HandleVisibility','off')
hold on
scatter(devB(1),devB(3),'x','HandleVisibility','off')
scatter(devC(1),devC(3),'x','HandleVisibility','off')
scatter(devD(1),devD(3),'x','HandleVisibility','off')
scatter(devE(1),devE(3),'x','HandleVisibility','off')
scatter(devF(1),devF(3),'x','HandleVisibility','off')
scatter(devG(1),devG(3),'x','HandleVisibility','off')
...
yzfig = figure;
scatter(devA(2),devA(3),'x','HandleVisibility','off')
hold on
scatter(devB(2),devB(3),'x','HandleVisibility','off')
scatter(devC(2),devC(3),'x','HandleVisibility','off')
scatter(devD(2),devD(3),'x','HandleVisibility','off')
scatter(devE(2),devE(3),'x','HandleVisibility','off')
scatter(devF(2),devF(3),'x','HandleVisibility','off')
scatter(devG(2),devG(3),'x','HandleVisibility','off')
